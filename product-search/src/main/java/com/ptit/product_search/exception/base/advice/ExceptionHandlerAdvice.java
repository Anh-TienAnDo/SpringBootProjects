package com.ptit.product_search.exception.base.advice;
// package com.ptit.product_search.exception.base.advice;


// import com.ptit.product_search.dto.response.ResponseGeneral;
// import com.ptit.product_search.exception.base.BaseException;
...
// import  com.ptit.product_search.dto.response.Error;
...
// import static com.ptit.product_search.constants.product_searchProjectConstants.CommonConstants.DEFAULT_LANGUAGE;
// import static com.ptit.product_search.constants.product_searchProjectConstants.CommonConstants.LANGUAGE;
...
//           com.ptit.product_search.dto.response.Error.of(code, getMessage(code, new Locale(language)))
//     );
//   }
...
//           status,
//           HttpStatus.valueOf(status).getReasonPhrase(),
//           com.ptit.product_search.dto.response.Error.of(code, getMessage(code, locale, params))
//     );
//   }
